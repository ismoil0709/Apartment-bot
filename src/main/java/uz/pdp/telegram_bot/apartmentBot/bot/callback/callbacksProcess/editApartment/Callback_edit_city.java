...
public class Callback_edit_city {
    ...
    public static void sendMessage(Update update, TelegramLongPollingBot bot) {
        ...
        GetAndSetStates.setBackButtonState(update, StateForBack.EDIT_CITY);
        GetAndSetStates.setWriteState(update, StateForWrite.WRITE_EDIT_CITY);
    }
}
