...
public class Callback_edit_email {
    public static void process(Update update, TelegramLongPollingBot bot){
        if(update.hasMessage()){
            if (Regex.emailValidator(update.getMessage().getText())){
                ...
                GetAndSetStates.setWriteState(update,StateForWrite.WRITE_EDIT_EMAIL);
            }
        }
    }
    public static void sendMessage(Update update,TelegramLongPollingBot bot){
        try {
            ...
            GetAndSetStates.setWriteState(update, StateForWrite.WRITE_EDIT_EMAIL);
            GetAndSetStates.setBackButtonState(update, StateForBack.EDIT_EMAIL);
        } catch (TelegramApiException e) {
            throw new RuntimeException(e);
        }
    }
