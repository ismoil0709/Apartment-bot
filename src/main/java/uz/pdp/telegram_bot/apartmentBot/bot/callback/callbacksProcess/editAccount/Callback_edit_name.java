...
public class Callback_edit_name {
    ...
    public static void sendMessage(Update update, TelegramLongPollingBot bot) {
        try {
            ...
            GetAndSetStates.setWriteState(update, StateForWrite.WRITE_EDIT_NAME);
            GetAndSetStates.setBackButtonState(update, StateForBack.EDIT_NAME);
        } catch (TelegramApiException e) {
            throw new RuntimeException(e);
        }
    }
